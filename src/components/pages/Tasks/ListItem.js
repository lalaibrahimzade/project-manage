      ...
      {(provided, snapshot) => {
        return (
          ...
          >
            ...
            <div className="flex flex-align-center flex-between add-task drog">
              <div>
                <b>Assigned users</b>
              </div>
              <Avatar.Group>
              ...
              <div className="flex flex-end deletandedit">
                <Tooltip
                  className="ml-5"
                  title={t("Edit")}
                  placement="topRight"
                  ...
                  <Tooltip className="ml-5" title={"Delete"}>
                    {user.role.deleteTask && (
                      <Button
                        ...
                        shape="circle"
                      >
                        <CloseOutlined  style={{fontSize:"15px", fontWeight:"700"}}/>
                      </Button>
                    )}
                  </Tooltip>
                </Popconfirm>
...
export default connect(mapStateToProps, { setVisibleAddModal, getTasks })(
  ListItem
);
