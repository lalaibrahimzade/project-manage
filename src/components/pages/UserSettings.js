...
const UserSettings = (props) => {
    ...
    return (
        <Row gutter={[10, 10]}>
            <Col xs={24}>
                <div className="border animated fadeInDown p-2 mt-0 bg-set">
                    <SettingOutlined  className="f-20 mr5-15" style={{fontSize:"30px", color:"#635fc7"}} />
                    <span className="f-20 bold ms-3" style={{fontWeight:"500", color:"#635fc7", fontSize:"20px"}}>User info</span>
                </div>
            </Col>
            <Col lg={12} xs={24}>
                {companyData.role.changeSettings && (
                    <Card style={{background:"#A8A4FF"}}>
                        <div>
                            <List
                                header={false}
                                footer={false}
            ...
            {companyData.role.changeSettings && (
                <Col lg={12} xs={24}>
                    <Card title={false} className={"animated fadeInRight"} style={{background:"#A8A4FF"}}>
                        <Form
                            form={form}
                            name="basic"
                            layout="vertical"
