...
import {UserOutlined, SettingOutlined, LogoutOutlined, CalendarOutlined } from "@ant-design/icons";
            ...
            >
                <div className="d-flex justify-content-end align-items-center">
                    ...
                    <Popover placement="bottomLeft" title={text} content={content} trigger="click">
                        <Avatar className="me-3 mt-3 d-flex justify-content-center align-items-center" size={30} icon={<UserOutlined />} style={{background:"#A8A4FF"}}/>                
                    </Popover>
                </div>
            </Header>
        </>
